...
local function getBtnsWidth() -- close
  local width = 6
...
M.run = function()
  local modules = require "ysf.bufferline.modules"
  ...
  -- local result = modules.bufferlist() .. (modules.tablist() or "")
